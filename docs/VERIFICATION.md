...
- Выход аннулирует токен: следующий запрос с ним возвращает 401; повторный вход работает.
...
После проверок все созданные тестовые карточки и оба временных аккаунта удалены.
